...
- **可视化编辑器** — 内置 tkinter 编辑工具，可视化修改精灵/技能/道具/训练师/剧情文本
...
- **角色编辑**：训练师数据（队伍、奖励、对话）
- **剧情文本**：对话文本编辑，支持字符串/数组/嵌套字典
- **数据持久化**：直接读写 species.json / moves.json / items.json / trainers.json / dialogs.json
...
| 数据 | JSON（species / moves / items / trainers / dialogs） |
